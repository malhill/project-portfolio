  ...
  return (
    <div className="text-center page-height">
      ...
      <h2 className="text-center mb-5">
        Select one of the projects below to view the live applications:
      </h2>
      ...
      <div className="container">
        <div className="row d-flex align-items-center">
          <div className="col-4 mb-5">
            ...
            <a
              ...
              href="https://github.com/malhill/strapcityBC"
            >
        ...
        <div className="row d-flex align-items-center">
          <div className="col-4">
            <a
              href="https://malhill.github.io/Calendar/"
            ...
            <a
              className="text-decoration-none active"
              href="https://github.com/malhill/Calendar"
            >
              Click here for Repository
            </a>
          </div>
          ...
          <div className="col-4">
            <a
              href="https://malhill.github.io/getty-gallery/"
          ...
          <div className="col-4">
            <a
              href="https://malhill.github.io/Weather-Dashboard/"
